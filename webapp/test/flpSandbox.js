			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrtoya01-display": {
								"semanticObject": "zrtoya01",
								"action": "display",
								"description": "Zadanie rekrutacyjne TOYA S.A.",
								"title": "Zadanie rekrutacyjne TOYA S.A.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrtoya01",
									"url": sap.ui.require.toUrl("zrtoya01")
								}
							}
						}
					}
